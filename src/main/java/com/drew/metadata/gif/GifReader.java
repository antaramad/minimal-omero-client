...
public class GifReader
{
    ...
    public void extract(@NotNull final SequentialReader reader, final @NotNull Metadata metadata)
    {
        ...
        com.drew.metadata.gif.GifHeaderDirectory header;
        try {
        ...
        try {
            ...
            try {
                boolean hasGlobalColorTable = header.getBoolean(com.drew.metadata.gif.GifHeaderDirectory.TAG_HAS_GLOBAL_COLOR_TABLE);
                if(hasGlobalColorTable) {
                    globalColorTableSize = header.getInteger(com.drew.metadata.gif.GifHeaderDirectory.TAG_COLOR_TABLE_SIZE);
                }
    ...
    private static com.drew.metadata.gif.GifHeaderDirectory readGifHeader(@NotNull final SequentialReader reader) throws IOException
    {
        // FILE HEADER
        //
        // 3 - signature: "GIF"
        ...
        com.drew.metadata.gif.GifHeaderDirectory headerDirectory = new com.drew.metadata.gif.GifHeaderDirectory();
        ...
        headerDirectory.setString(com.drew.metadata.gif.GifHeaderDirectory.TAG_GIF_FORMAT_VERSION, version);

        // LOGICAL SCREEN DESCRIPTOR

        headerDirectory.setInt(com.drew.metadata.gif.GifHeaderDirectory.TAG_IMAGE_WIDTH, reader.getUInt16());
        headerDirectory.setInt(com.drew.metadata.gif.GifHeaderDirectory.TAG_IMAGE_HEIGHT, reader.getUInt16());
        ...
        headerDirectory.setInt(com.drew.metadata.gif.GifHeaderDirectory.TAG_COLOR_TABLE_SIZE, colorTableSize);

        if (version.equals(GIF_89A_VERSION_IDENTIFIER)) {
            boolean isColorTableSorted = (flags & 8) != 0;
            headerDirectory.setBoolean(com.drew.metadata.gif.GifHeaderDirectory.TAG_IS_COLOR_TABLE_SORTED, isColorTableSorted);
        }

        headerDirectory.setInt(com.drew.metadata.gif.GifHeaderDirectory.TAG_BITS_PER_PIXEL, bitsPerPixel);
        headerDirectory.setBoolean(com.drew.metadata.gif.GifHeaderDirectory.TAG_HAS_GLOBAL_COLOR_TABLE, hasGlobalColorTable);

        headerDirectory.setInt(com.drew.metadata.gif.GifHeaderDirectory.TAG_BACKGROUND_COLOR_INDEX, reader.getUInt8());
