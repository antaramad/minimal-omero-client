...
public class ImageMetadataReader
{
     ...
     * @throws com.drew.imaging.ImageProcessingException if the file type is unknown, or for general processing errors.
     */
    @NotNull
    public static Metadata readMetadata(@NotNull final InputStream inputStream) throws com.drew.imaging.ImageProcessingException, IOException
    {
     ...
     */
    @NotNull
    public static Metadata readMetadata(@NotNull final InputStream inputStream, final long streamLength) throws com.drew.imaging.ImageProcessingException, IOException
    {
     ...
     */
    @NotNull
    public static Metadata readMetadata(@NotNull final InputStream inputStream, final long streamLength, final FileType fileType) throws IOException, com.drew.imaging.ImageProcessingException
    {
        switch (fileType) {
            case Jpeg:
            ...
            case Unknown:
                throw new com.drew.imaging.ImageProcessingException("File format could not be determined");
            default:
                return new Metadata();
        }
    }
     ...
     * @return a populated {@link Metadata} object containing directories of tags with values and any processing errors.
     * @throws com.drew.imaging.ImageProcessingException for general processing errors.
     */
    @NotNull
