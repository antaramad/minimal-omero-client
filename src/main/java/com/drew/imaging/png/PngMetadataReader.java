...
public class PngMetadataReader
{
    ...
    @NotNull
    public static Metadata readMetadata(@NotNull File file) throws com.drew.imaging.png.PngProcessingException, IOException
    {
    ...
    @NotNull
    public static Metadata readMetadata(@NotNull InputStream inputStream) throws com.drew.imaging.png.PngProcessingException, IOException
    {
        Iterable<com.drew.imaging.png.PngChunk> chunks = new PngChunkReader().extract(new StreamReader(inputStream), _desiredChunkTypes);

        Metadata metadata = new Metadata();

        for (com.drew.imaging.png.PngChunk chunk : chunks) {
            try {
    ...
    private static void processChunk(@NotNull Metadata metadata, @NotNull PngChunk chunk) throws PngProcessingException, IOException
    {
        ...
        if (chunkType.equals(PngChunkType.IHDR)) {
            com.drew.imaging.png.PngHeader header = new PngHeader(bytes);
            ...
            com.drew.imaging.png.PngChromaticities chromaticities = new PngChromaticities(bytes);
