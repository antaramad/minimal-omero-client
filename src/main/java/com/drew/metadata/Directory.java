...
// TAG SETTERS
     ...
     */
    @java.lang.SuppressWarnings({ "ConstantConditions" })
    public void setStringValue(int tagType, @NotNull com.drew.metadata.StringValue value)
    {
        if (value == null)
     ...
     */
    public void setStringValueArray(int tagType, @NotNull com.drew.metadata.StringValue[] strings)
    {
        setObjectArray(tagType, strings);
    }
...
// TAG GETTERS
     ...
     * </ul>
     *
     * @throws com.drew.metadata.MetadataException if no value exists for tagType or if it cannot be converted to an int.
     */
    public int getInt(int tagType) throws com.drew.metadata.MetadataException
    {
        ...
        if (o == null)
            throw new com.drew.metadata.MetadataException("Tag '" + getTagName(tagType) + "' has not been set -- check using containsTag() first");
        throw new com.drew.metadata.MetadataException("Tag '" + tagType + "' cannot be converted to int.  It is of type '" + o.getClass() + "'.");
    }
    ...
    public Integer getInteger(int tagType)
    {
        ...
        } else if (o instanceof String || o instanceof com.drew.metadata.StringValue) {
            try {
    ...
    public String[] getStringArray(int tagType)
    {
        ...
        if (o instanceof com.drew.metadata.StringValue)
            return new String[] { o.toString() };
        if (o instanceof com.drew.metadata.StringValue[]) {
            com.drew.metadata.StringValue[] stringValues = (com.drew.metadata.StringValue[])o;
     ...
     */
    @Nullable
    public com.drew.metadata.StringValue[] getStringValueArray(int tagType)
    {
        Object o = getObject(tagType);
        if (o == null)
            return null;
        if (o instanceof com.drew.metadata.StringValue[])
            return (com.drew.metadata.StringValue[])o;
        if (o instanceof com.drew.metadata.StringValue)
            return new com.drew.metadata.StringValue[] {(com.drew.metadata.StringValue) o};
        return null;
    }
    ...
    public byte[] getByteArray(int tagType)
    {
        ...
        if (o == null) {
            return null;
        } else if (o instanceof com.drew.metadata.StringValue) {
            return ((com.drew.metadata.StringValue)o).getBytes();
        } else if (o instanceof Rational[]) {
            Rational[] rationals = (Rational[])o;
    ...
    public double getDouble(int tagType) throws com.drew.metadata.MetadataException
    {
        ...
        if (o == null)
            throw new com.drew.metadata.MetadataException("Tag '" + getTagName(tagType) + "' has not been set -- check using containsTag() first");
        throw new com.drew.metadata.MetadataException("Tag '" + tagType + "' cannot be converted to a double.  It is of type '" + o.getClass() + "'.");
    }
    ...
    public Double getDoubleObject(int tagType)
    {
        ...
        if (o == null)
            return null;
        if (o instanceof String || o instanceof com.drew.metadata.StringValue) {
            try {
    ...
    public float getFloat(int tagType) throws com.drew.metadata.MetadataException
    {
        ...
        if (o == null)
            throw new com.drew.metadata.MetadataException("Tag '" + getTagName(tagType) + "' has not been set -- check using containsTag() first");
        throw new com.drew.metadata.MetadataException("Tag '" + tagType + "' cannot be converted to a float.  It is of type '" + o.getClass() + "'.");
    }
    ...
    public long getLong(int tagType) throws com.drew.metadata.MetadataException
    {
        ...
        if (o == null)
            throw new com.drew.metadata.MetadataException("Tag '" + getTagName(tagType) + "' has not been set -- check using containsTag() first");
        throw new com.drew.metadata.MetadataException("Tag '" + tagType + "' cannot be converted to a long.  It is of type '" + o.getClass() + "'.");
    }
    ...
    public boolean getBoolean(int tagType) throws com.drew.metadata.MetadataException
    {
    ...
    @Nullable
    public com.drew.metadata.StringValue getStringValue(int tagType)
    {
        Object o = getObject(tagType);
        if (o instanceof com.drew.metadata.StringValue)
