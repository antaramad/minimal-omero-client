...
public class PngChunkType
{
    ...
    //
    /**
     * Denotes a critical {@link com.drew.imaging.png.PngChunk} that contains basic information about the PNG image.
     ...
     *     <li><b>color type</b> 1 byte, maps to {@link com.drew.imaging.png.PngColorType} enum</li>
    ...
    /**
     * Denotes a critical {@link com.drew.imaging.png.PngChunk} that contains palette entries.
    ...
    static {
        ...
        } catch (com.drew.imaging.png.PngProcessingException e) {
    ...
    public PngChunkType(@NotNull String identifier) throws com.drew.imaging.png.PngProcessingException
    {
        this(identifier, false);
    }

    public PngChunkType(@NotNull String identifier, boolean multipleAllowed) throws com.drew.imaging.png.PngProcessingException
    {
    ...
    public PngChunkType(@NotNull byte[] bytes) throws com.drew.imaging.png.PngProcessingException
    {
        validateBytes(bytes);
        _bytes = bytes;
    ...
    private static void validateBytes(byte[] bytes) throws com.drew.imaging.png.PngProcessingException
    {
        if (bytes.length != 4) {
            throw new com.drew.imaging.png.PngProcessingException("PNG chunk type identifier must be four bytes in length");
        }
