 ...
 */
public abstract class QuickTimeMetadataHandler extends QuickTimeHandler<com.drew.metadata.mov.QuickTimeDirectory>
{
    ...
    {
        return atom.type.equals(com.drew.metadata.mov.QuickTimeAtomTypes.ATOM_HANDLER)
            || atom.type.equals(com.drew.metadata.mov.QuickTimeAtomTypes.ATOM_KEYS)
            || atom.type.equals(com.drew.metadata.mov.QuickTimeAtomTypes.ATOM_DATA);
    }
    ...
    protected QuickTimeHandler<?> processAtom(@NotNull Atom atom, @Nullable byte[] payload, QuickTimeContext context) throws IOException
    {
        if (payload != null) {
            ...
            if (atom.type.equals(com.drew.metadata.mov.QuickTimeAtomTypes.ATOM_KEYS)) {
                processKeys(reader);
